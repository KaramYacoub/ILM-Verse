	...
	<section className='relative bg-gradient-to-r from-[#8A0E31] to-[#8A0E31] text-white py-16 md:py-24'>
		<div className='container mx-auto text-center max-w-3xl px-4'>
			...
			<div className='flex flex-wrap justify-center gap-4'>
				<a
					href='#story'
					className='bg-[#FAC67A] text-[#8A0E31] px-6 py-3 rounded-lg hover:scale-105 transition-transform'>
					Our Story
				</a>
			</div>
		</div>
...
function AboutUs() {
	...
	return (
		<div className='min-h-screen flex flex-col'>
			...
			<section className='bg-gradient-to-r from-[#primary] to-[#5D0921] text-white py-16'>
				<div className='container mx-auto text-center'>
					<h2 className='text-3xl font-bold mb-8'>Ready to Join Us?</h2>
					<a
						href='/admissions'
						className='inline-block bg-[#FAC67A] text-[#primary] px-8 py-3 rounded-lg text-lg font-medium hover:bg-[#f8b858] transition-colors'>
